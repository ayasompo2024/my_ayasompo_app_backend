...
trait Common
{
    public function getAccountCode($user)
    {
    ...
    public function getAgentAccountCodeByCustomerID($profile)
    {
        return AgentAccountCode::select('customer_id', 'code')->where('customer_id', $profile->id)->get();
    }

    public function getCurrentAuthAgent($user)
    {
    ...
    public function agentAccountCodesAsStringFormat($agent_account_code_array)
    {
