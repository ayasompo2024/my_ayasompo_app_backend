            ...
            <div class="row mt-2">
                <div class="col-md-12 px-md-5 rounded mb-5">
                    <h5 class="mt-4 pb-2 border-bottom">
                        <span class="float-right"> Update Location Map Category</span>
                        <a href="{{ url()->previous() }}"><i class="bi bi-arrow-left-square"></i></a>
                    </h5>
                    <form class="mt-4" method="POST"
                        action="{{ route('admin.location-map-category.update', $category->id) }}"
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-8">
                                <div class="card old-photo"
                                    style="width: 200px;height: 200px;background-size: cover; background-image: url({{ $category->image }})">
                                </div>
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-lg-8">
                                <input id="name" value="{{ $category->name }}" type="text" name="name"
                                    autocomplete="name" class="form-control form-control-sm" placeholder="Enter Name">
                            </div>
                        </div>
                        <div class="row mt-3">
                            <div class="col-lg-4">
                            ...
                            <div class="col-lg-8">
                                <input id="sort" value="{{ $category->sort }}" type="number" name="sort"
