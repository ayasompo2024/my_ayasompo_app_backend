...
trait SaleTargetMessage
{
    private function messageLists()
    {
        return [
            ...
            [
                "title" => "Just 0.5 Mil away from 3 Mil target.",
            ...
            [
                "title" => "Congratulations! You've reached your 3 Mil target.",
            ...
            [
                "title" => "Just 0.5 Mil away from 5 Mil target.",
            ...
            [
                "title" => "Congratulations! You've reached your 5 Mil target.",
            ...
            [
                "title" => "Just 0.5 Mil away from 7 Mil target.",
            ...
            [
                "title" => "Congratulations! You've reached your 7 Mil target.",
            ...
            [
                "title" => "Just 0.5 Mil away from 12 Mil target.",
            ...
            [
                "title" => "Congratulations! You've reached your 12 Mil target.",
