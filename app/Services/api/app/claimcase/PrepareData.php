...
{
    //For API
    public function prepareDataForMotorClaimAPI($request)
    {
        $data = [
    ...
    public function prepareDataForNonMotorClaimAPI($request, $accidentDamagedPhotos, $signature_image)
    {
        $data = [
    ...
    //For Lara Store
    public function prepareDataStoreMotorCase($request)
    {
        $data = [
