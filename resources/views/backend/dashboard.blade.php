...
<head>
    ...
    <link rel='stylesheet' type='text/css' property='stylesheet'
        href='//shop.microland.cloud/_debugbar/assets/stylesheets?v=1661842240&theme=auto' data-turbolinks-eval='false'
        data-turbo-eval='false'>
    <script src='//shop.microland.cloud/_debugbar/assets/javascript?v=1661842240' data-turbolinks-eval='false'
            ...
            <div class="aiz-sidebar left c-scrollbar">
                <div class="aiz-side-nav-logo-wrap">
                    <a href="http://shop.microland.cloud/admin" class="d-block text-left">
                        <img class="mw-100" src="" class="brand-icon" alt="Microland Ecommerce Platform">
                    </a>
                </div>
                            ...
                            <ul class="aiz-side-nav-list level-2">
                                <li class="aiz-side-nav-item">
                                    <a class="aiz-side-nav-link"
                                        href="http://shop.microland.cloud/admin/products/create">
                                ...
                                <li class="aiz-side-nav-item">
                                    <a href="http://shop.microland.cloud/admin/products/admin"
                                        class="aiz-side-nav-link ">
                                        <span class="aiz-side-nav-text">In House Products</span>
                                    </a>
                                </li>
                                <li class="aiz-side-nav-item">
                                    <a href="http://shop.microland.cloud/admin/products/seller"
                                        class="aiz-side-nav-link ">
                                        <span class="aiz-side-nav-text">Seller Products</span>
                                    </a>
                                </li>
                                <li class="aiz-side-nav-item">
                                    <a href="http://shop.microland.cloud/admin/digitalproducts"
                                        class="aiz-side-nav-link ">
                                        <span class="aiz-side-nav-text">Digital Products</span>
                                    </a>
                                </li>
                                <li class="aiz-side-nav-item">
                                    <a href="http://shop.microland.cloud/admin/product-bulk-upload/index"
                                        class="aiz-side-nav-link">
                                        <span class="aiz-side-nav-text">Bulk Import</span>
                                    </a>
                                </li>
                                <li class="aiz-side-nav-item">
                                    <a href="http://shop.microland.cloud/admin/product-bulk-export"
                                        class="aiz-side-nav-link">
                        ...
                        <div class="d-flex justify-content-around align-items-center align-items-stretch">
                            <div class="aiz-topbar-item">
                                <div class="d-flex align-items-center">
                                    <a class="btn btn-icon btn-circle btn-light" href="http://shop.microland.cloud"
                            ...
                            <div class="aiz-topbar-item">
                                <div class="d-flex align-items-center">
                                    <a class="btn btn-soft-danger btn-sm d-flex align-items-center"
                                        href="http://shop.microland.cloud/admin/clear-cache">
                            ...
                            <div class="align-items-stretch d-flex dropdown">
                                ...
                                <div
                                    ...
                                    <div class="text-center border-top">
                                        <a href="http://shop.microland.cloud/admin/all-notification"
                            ...
                            <div class="align-items-stretch d-flex dropdown " id="lang-change">
                                <a class="dropdown-toggle no-arrow" data-toggle="dropdown" href="javascript:void(0);"
                                    ...
                                    <span class="btn btn-icon">
                                        <img src="http://shop.microland.cloud/public/assets/img/flags/mm.png"
                                            height="11">
                                    </span>
                                </a>
                                <ul class="dropdown-menu dropdown-menu-right dropdown-menu-animated dropdown-menu-xs">
                                    ...
                                    <li>
                                        <a href="javascript:void(0)" data-flag="en" class="dropdown-item ">
                                            <img src="http://shop.microland.cloud/public/assets/img/flags/en.png"
                                                class="mr-2">
                                    ...
                                    <li>
                                        <a href="javascript:void(0)" data-flag="cn" class="dropdown-item ">
                                            <img src="http://shop.microland.cloud/public/assets/img/flags/cn.png"
                                                class="mr-2">
                                ...
                                <a class="dropdown-toggle no-arrow text-dark" data-toggle="dropdown"
                                    ...
                                    <span class="d-flex align-items-center">
                                        <span class="avatar avatar-sm mr-md-2">
                                            <img src="http://shop.microland.cloud/public/assets/img/placeholder.jpg"
