...
class ClaimcaseController extends Controller
{
    ...
    public function motorCase(MotorClaimcaseRequest $request, ClaimcaseService $claimcaseService)
    {
    ...
    public function nonMotorCase(NonMotorClaimcaseRequest $request, ClaimcaseService $claimcaseService)
    {
